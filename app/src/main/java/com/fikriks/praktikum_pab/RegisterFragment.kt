...
import com.fikriks.praktikum_pab.databinding.FragmentLoginBinding
import com.fikriks.praktikum_pab.databinding.FragmentRegisterBinding
...
class RegisterFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.createAccountButton.setOnClickListener {
            val intent = Intent(requireContext(), RegisterSuccessActivity::class.java)
