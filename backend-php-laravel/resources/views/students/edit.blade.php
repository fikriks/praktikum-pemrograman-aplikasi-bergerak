...
@section('content')
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('students.update', $student['user_id']) }}" method="POST" class="form form-horizontal">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 form-group">
                                <input type="text" id="nama"
                                    ...
                                    placeholder="Nama" value="{{ old('nama', $student['nama']) }}" required>
                            ...
                            <div class="col-md-8 form-group">
                                <input type="text" id="kelas"
                                    ...
                                    placeholder="Kelas" value="{{ old('kelas', $student['kelas']) }}" required>
                            ...
                            <div class="col-md-8 form-group">
                                <input type="email" id="email"
                                    ...
                                    placeholder="Email" value="{{ old('email', $student['email']) }}" required>
